...
uint8_t nodeDeviceEUI[8] = {0x60, 0x81, 0xF9, 0xB1, 0xED, 0x17, 0x5E, 0x8B};
uint8_t nodeAppEUI[8] = {0x60, 0x81, 0xF9, 0xA1, 0x8A, 0xEB, 0x66, 0xCB};
uint8_t nodeAppKey[16] = {0x45, 0x72, 0x24, 0x6F, 0x4D, 0x83, 0x6B, 0xC3, 0x30, 0x31, 0x7A, 0x1A, 0x33, 0x27, 0x4B, 0xD4};
